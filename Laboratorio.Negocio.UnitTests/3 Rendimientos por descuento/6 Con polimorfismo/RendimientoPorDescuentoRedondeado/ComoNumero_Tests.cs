...
using Negocio.RendimientosPorDescuento.ConPolimorfismo;
using System;

namespace Laboratorio.Negocio.UnitTests.RendimientosPorDescuento.ConPolimorfismo.RendimientoPorDescuentoRedondeado_Tests
{
    [TestClass]
