...
namespace Laboratorio.Negocio.UnitTests.CodigosDeReferencia.ComoUnProcedimiento
{
    [TestClass()]
    public class GenereElRequerimientoComoTexto_Tests
    {
        ...
        [TestMethod()]
        public void GenereElRequerimientoComoTexto_AñoTieneTresDigitos_PrecedeConCero()
        {
            elResultadoEsperado = "0999011133322888888888888";

            laFecha = new DateTime(999, 1, 11);
            elResultadoObtenido = GeneracionDeCodigoDeReferencia.GenereElRequerimientoComoTexto(laFecha, elCliente, elSistema, elConsecutivo);
